...
RSpec.describe School, type: :model do
  ...
  context "when creating a valid school object" do
    it "does not raise any errors" do
          expect{create(:school,
                  ...
                  boundaries: valid_row[14])}.to_not raise_error
    end
  end

  context "when creating an invalid school object" do
    it "raises ActiveRecord::RecordInvalid error" do
         expect{create(:school,
                  ...
                  slug: invalid_row[14],
                  boundaries: invalid_row[15])}.to raise_error(ActiveRecord::RecordInvalid)
    end
  end

    context "when creating a school object with duplicate slug" do
      it "raises ActiveRecord::RecordInvalid error" do
                  create(:school,
                      name: valid_row[0],
                      school_type: valid_row[1],
